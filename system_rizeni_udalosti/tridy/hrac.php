...
class hrac extends Trida_generujici_udalosti {
    ...
    public function zapis_udaje_po_konci_kola_do_databaze($mnozstvi_spotrebniho_zbozi_na_sklade,
        $mnozstvi_kapitaloveho_zbozi_na_sklade, $mnozstvi_kapitalu) {
        $dotaz = "UPDATE hraci SET " .
        " mnozstvi_kapitalu " . $mnozstvi_kapitalu .
        " mnozstvi_spotrebniho_zbozi_na_sklade " . $mnozstvi_spotrebniho_zbozi_na_sklade .
        " mnozstvi_kapitaloveho_zbozi_na_sklade " . $mnozstvi_kapitaloveho_zbozi_na_sklade .
