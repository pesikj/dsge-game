...
class Spravce_informaci_pro_prehled {
    ...
    public function get_data_o_kapitalu($data_pro_prognozu) {
        ...
        $dotaz_na_stav_kapitalu_z_predminuleho_kola = "SELECT mnozstvi_kapitalu FROM skladovane_polozky WHERE " .
            "login = '" . $login . "' AND kolo = " .  ($cislo_minuleho_kola - 1) . ";";
        $vysledek_stav_kapitalu_z_predminuleho_kola = mysql_query($dotaz_na_stav_kapitalu_z_predminuleho_kola) or die ($dotaz_na_stav_kapitalu_z_predminuleho_kola);
        if (mysql_num_rows($vysledek_stav_kapitalu_z_predminuleho_kola) == 1) {
            ...
            $dotaz_na_zmenu_hotovosti = "SELECT (SELECT mnozstvi_kapitalu FROM skladovane_polozky WHERE " .
                "login = '" . $login . "' AND kolo = " .  $cislo_minuleho_kola . ") -
                " . $GLOBALS['spravce_konfigurace']->get_pocatecni_hodnotu("kapital") . " AS pohyb_hotovosti;";
