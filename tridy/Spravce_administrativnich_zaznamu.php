...
class Spravce_administrativnich_zaznamu extends Trida_reagujici_na_udalosti{
    ...
    public function __construct() {
        ...
        $this->pole_identifikatoru_udalosti['ZADOST_NOVEHO_HRACE_O_ZAPOJENI_DO_HRY'] = 'zapoj_hrace_do_hry';
        parent::__construct();
    ...
    public function zapoj_hrace_do_hry ($odesilatel, $parametry) {
        ...
        $dotaz_na_vlozeni_hrace_do_tabulky_hracu = "INSERT INTO hraci VALUES ('" . $login . "', 'not_defined' , CURRENT_TIMESTAMP, 0); ";
        mysql_query($dotaz_na_vlozeni_hrace_do_tabulky_hracu) or die ($dotaz_na_vlozeni_hrace_do_tabulky_hracu);

        $dotaz_na_vlozeni_vychozich_hodnot = "INSERT INTO skladovane_polozky VALUES ('" . $login . "', " . $this->cislo_kola . " , " .
             $spravce_konfigurace->get_pocatecni_hodnotu("kapital") . ", " .
             $spravce_konfigurace->get_pocatecni_hodnotu("spotrebni_zbozi_na_sklade") . ", " .
             $spravce_konfigurace->get_pocatecni_hodnotu("kapitalove_zbozi_na_sklade") . "); ";
        mysql_query($dotaz_na_vlozeni_vychozich_hodnot) or die ($dotaz_na_vlozeni_vychozich_hodnot);

        $dotaz_kapitalove_zbozi_ve_vyrobe = "INSERT INTO kapitalove_zbozi_ve_vyrobe VALUES ('" . $login . "', " . $this->cislo_kola . ", " .
             $spravce_konfigurace->get_pocatecni_hodnotu("kapitalove_zbozi_ve_vyrobe") . "); ";
        mysql_query($dotaz_kapitalove_zbozi_ve_vyrobe) or die ($dotaz_kapitalove_zbozi_ve_vyrobe);
    }
}
