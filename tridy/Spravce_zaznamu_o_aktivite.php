...
class Spravce_zaznamu_o_aktivite extends Trida_reagujici_na_udalosti {
    ...
    public function __construct() {
        $this->pole_identifikatoru_udalosti['ODESLANI_FORMULARE_POPTAVKY'] = 'zaznamenej_aktivitu';
        $this->pole_identifikatoru_udalosti['ODESLANI_FORMULARE_PRODUKCE'] = 'zaznamenej_aktivitu';
        $this->pole_identifikatoru_udalosti['ODESLANI_FORMULARE_NABIDKY'] = 'zaznamenej_aktivitu';
        parent::__construct();
